error id: file://<WORKSPACE>/src/main/java/com/tencent/wxcloudrun/controller/ChartController.java:_empty_/TigerKlineUtils#getKlineData#
file://<WORKSPACE>/src/main/java/com/tencent/wxcloudrun/controller/ChartController.java
empty definition using pc, found symbol in pc: _empty_/TigerKlineUtils#getKlineData#
...
public class ChartController {
    ...
    public ApiResponse getKlineData(@RequestParam String symbol) {
        try {
            List<Map<String, Object>> klineData = TigerKlineUtils.getKlin@@eData(symbol, 1);
